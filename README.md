...
Поэтому для того, чтобы его интегрировать в собственную конфигурацию нужно будет приложить много усилий.</p>
...
<p>Ну и конечно, эта конфигурация никак не сопровождается и не поддерживается. Все что вы делаете, вы делаете на свой страх и риск.</p>
